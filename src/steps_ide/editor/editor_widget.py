...
# Steps files use YAML highlighting as a reasonable approximation (indentation-based, colon syntax)
EXTENSION_TO_LANGUAGE = {
    # Steps language files - use YAML for reasonable syntax highlighting
    ".building": "yaml",
    ".floor": "yaml",
    ".step": "yaml",
    # Python
